...
def create_product():
    """
    Creates a Product
    This endpoint will create a Product based on the data in the request body
    """
...
def list_products():
    """
    List all Products
    This endpoint will return all products in the database
    """
...
def update_product(product_id):
    ...
    This endpoint will update a Product based on the data in the request body
    """
